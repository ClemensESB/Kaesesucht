...
<div class="background">   
    <div class="registration content-align-mid">
        <form method="POST" id="signupform" action="">
            ...
            <span id="firstNameError"><?echo (isset($errors['firstName']) ? $this->params['errors']['firstName'] : '');?></span>
            ...
            <span id="lastNameError"><?echo (isset($errors['lastName']) ? $this->params['errors']['lastName'] : '' );?></span>
            ...
            <span id="streetError"><?echo (isset($errors['street']) ? $this->params['errors']['street'] : '' );?></span>
            ...
            <span id="strNoError"><?echo (isset($errors['strNo']) ? $this->params['errors']['strNo'] : '' );?></span>
            ...
            <span id="zipCodeError"><?echo (isset($errors['zipCode']) ? $this->params['errors']['zipCode'] : '' );?></span>
            ...
            <span id="cityError"><?echo(isset($errors['city']) ? $this->params['errors']['city'] : '');?></span>
            ...
            <span id="emailError"><?echo(isset($errors['email']) ? $this->params['errors']['email'] : '' );?></span>
            ...
            <span id="passwordError"><?echo(isset($errors['password']) ? $this->params['errors']['password'] : '' );?></span>
            ...
            <span id="password1Error"><?echo(isset($errors['password1']) ? $this->params['errors']['password1'] : '' );?></span>
